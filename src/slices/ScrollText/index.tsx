...
const ScrollText: FC<ScrollTextProps> = ({ slice }) => {
  ...
  useGSAP(
    () => {
      ...
      if (!component || !textElement || !letters || !contentRef) return;
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef}>
        <div className="text-center text-sm tracking-wider text-neutral-200 uppercase md:mb-8 md:text-base">
          {slice.primary.eyebrow}
        </div>
        {/* <PrismicRichText field={slice.primary.text} /> */}
        <div ref={textRef} className="text-center">
          <p className="font-display flex flex-wrap justify-center text-5xl leading-tight text-balance uppercase md:text-5xl">
